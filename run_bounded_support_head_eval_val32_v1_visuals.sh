...
OUT=/data/zhucy23u/logs/learned_plane_params_v1/bounded_support_head_eval_val32_v1_visuals
SRC=/data/zhucy23u/logs/learned_plane_params_v1/bounded_support_head_eval_val32_v1
mkdir -p "${OUT}"
