...
PYTHON_BIN="${PYTHON_BIN:-/gemini/data-1/lightrecon_envs/planedust3r-py311-torch220-cu118/bin/python}"
...
OUT_DIR="${OUT_DIR:-/gemini/data-1/lightrecon_runs/plane_dust3r_same_input_smoke_scene00180_20260717_v1}"
...
"${PYTHON_BIN}" -c 'from importlib.metadata import version; import torch; import roma; print("torch=" + torch.__version__); print("roma=" + version("roma")); assert torch.cuda.is_available()'
