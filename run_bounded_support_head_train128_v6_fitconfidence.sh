...
OUTPUT_DIR=/data/zhucy23u/logs/learned_plane_params_v1/bounded_support_head_train128_v6_fitconfidence
CKPT=/data/zhucy23u/checkpoints/lightrecon_param/bounded_support_head_v6/train128_fitconfidence.pt
...
"$PYTHON" train_bounded_plane_support_head.py \
  ...
  --fit_confidence_weight 0.20 \
  --fit_confidence_distance_scale 0.03 \
  --fit_confidence_normal_power 2.0 \
